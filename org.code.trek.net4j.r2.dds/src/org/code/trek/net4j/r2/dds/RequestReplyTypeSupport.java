...
/**
 * A collection of useful methods for dealing with objects of type RequestReply
 */

public class RequestReplyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "RequestReply";

    private static final char[] PLUGIN_VERSION = { 2, 0, 0, 0 };
    private static final RequestReplyTypeSupport _singleton = new RequestReplyTypeSupport();
    ...
    /*
     * The methods in this section are for use by RTI Connext itself and by the code generated by rtiddsgen for other
     * types. They should be used directly or modified only by advanced users and are subject to change in future
     * versions of RTI Connext.
     */
    public static RequestReplyTypeSupport get_instance() {
        return _singleton;
    }

    public static RequestReplyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode() {
        return RequestReplyTypeCode.VALUE;
    }

    public Object create_data() {
        return RequestReply.create();
    }
    ...
    public Class get_type() {
        return RequestReply.class;
    }

    /**
     * This is a concrete implementation of this method inherited from the base class. This method will perform a deep
     * copy of <code>source</code> into <code>destination</code>.
     * 
     * @param src
     ...
     *                If either <code>destination</code> or <code>this</code> is not a <code>RequestReply</code> type.
     */
    public Object copy_data(Object destination, Object source) {

        RequestReply typedDst = (RequestReply) destination;
        RequestReply typedSrc = (RequestReply) source;
    ...
    public long get_serialized_sample_size(Object endpoint_data, boolean include_encapsulation, short encapsulation_id,
        ...
        RequestReply typedSrc = (RequestReply) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.clientId);
    ...
    public void serialize(Object endpoint_data, Object src, CdrOutputStream dst, boolean serialize_encapsulation,
        ...
        if (serialize_sample) {
            ...
            dst.writeString(typedSrc.clientId, (255));

            dst.writeByteSeq(typedSrc.payload, (256));
        }
    ...
    public long serialize_to_cdr_buffer(byte[] buffer, long length, RequestReply src) {
    ...
    public Object deserialize_sample(Object endpoint_data, Object dst, CdrInputStream src,
        ...
        if (deserialize_sample) {
            ...
            RequestReply typedDst = (RequestReply) dst;
            typedDst.clear();
            try {
                typedDst.clientId = src.readString((255));
                src.readByteSequence(typedDst.payload, (256));
    ...
    public void deserialize_from_cdr_buffer(RequestReply dst, byte[] buffer, long length) {
    ...
    public Object serialized_sample_to_key(Object endpoint_data, Object sample, CdrInputStream src,
        ...
        if (deserialize_key) {
            ...
            RequestReply typedDst = (RequestReply) sample;
    ...
    public void key_to_instance(Object endpoint_data, Object instance, Object key) {
        RequestReply typedDst = (RequestReply) instance;
        RequestReply typedSrc = (RequestReply) key;
        typedDst.clientId = typedSrc.clientId;

    }

    /*
     * Fill in the given key based on the key fields of the given instance sample.
     */
    public void instance_to_key(Object endpoint_data, Object key, Object instance) {
        RequestReply typedDst = (RequestReply) key;
        RequestReply typedSrc = (RequestReply) instance;
        typedDst.clientId = typedSrc.clientId;

    }

    /*
     * Fill in the fields of the given KeyHash based on the key field(s) of the given instance sample. Important: The
     * fields of the instance ID cannot all be set to zero!
     */
    public void instance_to_keyhash(Object endpoint_data, KeyHash_t keyhash, Object instance) {
        ...
        serialize_key(endpoint_data, instance, md5Stream, false, CdrEncapsulation.CDR_ENCAPSULATION_ID_CDR_BE, true,
                null);
        ...
        if (endpointData.get_serialized_key_max_size() > KeyHash_t.KEY_HASH_MAX_LENGTH) {
            ...
            System.arraycopy(KeyHash_t.ZERO_KEYHASH.value, buffer.currentPosition(), keyhash.value,
                    buffer.currentPosition(), KeyHash_t.KEY_HASH_MAX_LENGTH - buffer.currentPosition());
        }

        keyhash.length = KeyHash_t.KEY_HASH_MAX_LENGTH;
    }

    public void serialized_sample_to_keyhash(Object endpoint_data, CdrInputStream src, KeyHash_t keyhash,
            boolean include_encapsulation, Object endpoint_plugin_qos) {
        int position = 0;
    ...
    protected DataWriter create_datawriter(long native_writer, DataWriterListener listener, int mask) {
        return new RequestReplyDataWriter(native_writer, listener, mask, this);
    }

    protected DataReader create_datareader(long native_reader, DataReaderListener listener, int mask) {

        return new RequestReplyDataReader(native_reader, listener, mask, this);
    ...
    protected RequestReplyTypeSupport() {

        /*
         * If the user data type supports keys, then the second argument to the constructor below should be true.
         * Otherwise it should be false.
         */

        super(TYPE_NAME, true, RequestReplyTypeCode.VALUE, RequestReply.class, TypeSupportType.TST_STRUCT,
                PLUGIN_VERSION);

    }

    protected RequestReplyTypeSupport(boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, RequestReplyTypeCode.VALUE, RequestReply.class, TypeSupportType.TST_STRUCT,
                PLUGIN_VERSION);
    }
}
