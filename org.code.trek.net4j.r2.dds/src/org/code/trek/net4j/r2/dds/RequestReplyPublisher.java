...
public class RequestReplyPublisher {
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        Topic topic = null;
        RequestReplyDataWriter writer = null;
        ...
        try {
            ...
            /*
             * To customize data writer QoS, use the configuration file USER_QOS_PROFILES.xml
             */

            writer = (RequestReplyDataWriter) publisher.create_datawriter(topic, Publisher.DATAWRITER_QOS_DEFAULT,
                    null /* listener */, StatusKind.STATUS_MASK_NONE);
            if (writer == null) {
            ...
            /*
             * For a data type that has a key, if the same instance is going to be written multiple times, initialize
             * the key here and register the keyed instance prior to writing
             */
            ...
            for (int count = 0; (sampleCount == 0) || (count < sampleCount); ++count) {
                System.out.println("Writing RequestReply, count " + count);
            ...
            /*
             * RTI Data Distribution Service provides finalize_instance() method for people who want to release memory
             * used by the participant factory singleton. Uncomment the following block of code for clean destruction of
